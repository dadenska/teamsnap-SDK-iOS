...
// not autogenerated
- (instancetype _Nullable)initWithBody:(NSString *_Nonnull)body subject:(NSString *_Nonnull)subject teamId:(NSString *_Nonnull)teamId recipients:(NSArray <TSDKMember *>*_Nonnull)recipients sender:(id<TSDKMessageSender> _Nonnull)sender isDraft:(BOOL)isDraft isLeague:(BOOL)isLeague;
